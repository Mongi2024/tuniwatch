...
with col3:
    style.kpi_card("🎯", "Analyses thèmes", str(kpis["total_analyses_themes"]), trend_type="neutral")

with col4:
    style.kpi_card("💭", "Analyses sentiments", str(kpis["total_analyses_sentiment"]), trend_type="neutral")
...
with col1:
    ...
    if evolution:
        ...
        style.afficher_graphique(fig_evol, hauteur=300)
    else:
